    ...
    <div class="row justify-content-center">
        <div class="col-lg-7">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <img src="/image/{{ $item->attributes->image }}" class="img-thumbnail" width="200" height="200">
                </div>
                    ...
                    <div class="row">
                        <form action="{{ route('cart.update') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <button class="btn btn-secondary btn-sm" style="margin-right: 25px;">Actualizar</button>
                            </div>
                        </form>
                        <form action="{{ route('cart.remove') }}" method="POST">
                            {{ csrf_field() }}
                            <input type="hidden" value="{{ $item->id }}" id="id" name="id">
                            <button class="btn btn-dark btn-sm" style="margin-right: 10px;">Borrar</i></button>
                        </form>
                    </div>
                </div>
            </div>
